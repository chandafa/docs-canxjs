  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-4xl">
      ...
      <div className="space-y-12">
        ...
        <section className="space-y-6">
          <h2 className="text-2xl font-semibold text-foreground">How to Downgrade</h2>
          
          <div className="space-y-4">
            <h3 className="text-xl font-medium text-foreground">1. Identify Target Version</h3>
            <p className="text-muted-foreground">
              Check the <a href="https://www.npmjs.com/package/canxjs?activeTab=versions" className="text-blue-400 hover:underline" target="_blank">NPM versions</a> or your <code>package.json</code> history to find the stable version you want to revert to (e.g., <code>1.5.0</code>).
            </p>
          </div>

          <div className="space-y-4">
            <h3 className="text-xl font-medium text-foreground">2. Install Specific Version</h3>
            <p className="text-muted-foreground">
              Use <code>bun add</code> (or <code>npm install</code>) with the specific version tag:
            </p>
            <CodeBlock language="bash" code={`bun add canxjs@1.5.0`} />
          </div>

          <div className="space-y-4">
            <h3 className="text-xl font-medium text-foreground">3. Revert Migrations (If applicable)</h3>
            <p className="text-muted-foreground">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-medium text-foreground">4. Clear Cache</h3>
            <p className="text-muted-foreground">
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-xl bg-card border border-border">
              <h4 className="font-medium text-foreground mb-2">&quot;Module not found&quot; errors</h4>
            ...
            <div className="p-4 rounded-xl bg-card border border-border">
              <h4 className="font-medium text-foreground mb-2">TypeScript Errors</h4>
              <p className="text-sm text-muted-foreground">
