    ...
    <div className="max-w-4xl">
      <div className="mb-12 animate-fade-in">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <Badge className="bg-green-500/20 text-green-400 border-green-500/30">v1.6.3</Badge>
        </div>
        <p className="text-lg text-zinc-400 leading-relaxed">
          Manage user state across requests with a powerful, driver-based session system. 
          CanxJS v1.6.3 introduces robust Database and Redis drivers for production-ready session handling.
        </p>
      </div>
