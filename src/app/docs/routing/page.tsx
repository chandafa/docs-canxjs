...
// New in v1.3.1: Controller-based routing
app.routes((router) => {
    ...
    <div className="max-w-4xl">
      ...
      <section className="mb-16 animate-slide-up delay-550">
        <h2 className="text-2xl font-semibold text-white mb-4 flex items-center gap-3">
          ...
          Controller-based Routing
          <Badge className="bg-green-500/20 text-green-400 border-green-500/30 text-xs">v1.3.1</Badge>
        </h2>
        <p className="text-zinc-400 mb-6">
          New in v1.3.1: Use <code className="text-zinc-300 bg-zinc-800 px-1.5 py-0.5 rounded">router.controller()</code> to 
